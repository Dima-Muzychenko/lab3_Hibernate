...
//        AutoCoursesEntity that = (AutoCoursesEntity) o;
//        return categoryA1 == that.categoryA1 && categoryA == that.categoryA && categoryB1 == that.categoryB1 && categoryB == that.categoryB && categoryC1 == that.categoryC1 && categoryC == that.categoryC && categoryD1 == that.categoryD1 && categoryD == that.categoryD && categoryC1E == that.categoryC1E && categoryBe == that.categoryBe && categoryCe == that.categoryCe && categoryD1E == that.categoryD1E && categoryDe == that.categoryDe && categoryT1 == that.categoryT1 && categoryT2 == that.categoryT2 && Objects.equals(institutionCode, that.institutionCode) && Objects.equals(coursesName, that.coursesName) && Objects.equals(address, that.address) && Objects.equals(teacherFullName, that.teacherFullName);
//    }
//
//    @Override
//    public int hashCode() {
//        return Objects.hash(institutionCode, categoryA1, categoryA, categoryB1, categoryB, categoryC1, categoryC, categoryD1, categoryD, categoryC1E, categoryBe, categoryCe, categoryD1E, categoryDe, categoryT1, categoryT2, coursesName, address, teacherFullName);
//    }
}
