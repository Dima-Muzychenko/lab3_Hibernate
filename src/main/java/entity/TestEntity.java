...
//    }
    ...
    public static Object[] getSelected(Object obj){
        ...
        objInfo[0]=String.valueOf(zm.getExaminationByExaminationId().getExaminationId());
        ...
        objInfo[4]=String.valueOf(zm.getNumberOfOrder());
        return objInfo;
    }
}
